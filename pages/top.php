...
<main>
  <div class="mainvisual-bg">
    <div class="mainvisual">
      <p class="mainvisual-catchcopy">名古屋市中村区の中古マンション特化型</p>
      <h1>不動産販売の精鋭集団<br>We're Professional</h1>
      <div class="flexbox">
        <div class="our-mission">
          <span>Our Mission</span>
        </div>
        <div class="mainvisual-content">
          <h3>中村区の分譲マンション情報がすぐにわかる</h3>
  ...
  <section class="flow">
    <h2 class="section-h2">Flow until <span>S</span>ale
    ...
    <ul class="flex-list">
      <li class="flex-item">
        <div class="flexbox">
          ...
          <div class="faq-body">
            <p class="question">ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。</p>
          </div>
        </div>
        <div class="flexbox">
          <div class="faq-head">
